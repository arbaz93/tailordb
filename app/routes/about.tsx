...
export default function about() {
  ...
  return (  // h=[100vh-footerHeight+headerHeight]
    <main className='flex flex-col justify-between items-center h-[calc(100vh-48px-60px)] px-8 pt-15 pb-5 text-text-100 font-medium text-clr-100'>
      ...
      <section>
        <div className='flex gap-4 items-center'>
          <CodeIcon className='w-5 fill-clr-100'/>
          <p className='flex-1'>Developed&Designed by <a  className='text-primary'>Yousaf Arbaz</a></p>
        </div>
      </section>
    </main>
  )
